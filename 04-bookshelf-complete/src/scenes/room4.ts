...
export function CreateRoom4(): void{
    ...
    let chandelier = new Chanderlier(new Transform({
    ...
    // Creating Book
    let book = new GenericRotate(new Transform({
    ...
    // Creating Couch
    let couch = new GenericMove(new Transform({
    ...
    // Creating Table
    let table = new GenericModel(new GLTFShape("models/room4/table.glb"), 
    new Transform({
        position: new Vector3(8.63, 0, 3.63)
    }));

    // Creating Wine Bottle
    let wineBottle = new GenericMove(new Transform({
    ...
    // Creating Wine Glass
    let wineGlass = new GenericMove(new Transform({
    ...
    // Creating Chair
    let chair = new GenericRotate(new Transform({
    ...
    let wallPainting = new GenericRotate(new Transform({
    ...
    // Creating Fake Door
    let fakeDoor = new GenericModel(new GLTFShape("models/generic/door.glb"), 
    new Transform({
