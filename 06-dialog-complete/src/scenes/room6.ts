...
export function CreateRoom6(gameCanvas: UICanvas): void {
  const door = new Door(
    ...
    {position:new Vector3(28.3,0.25,19.75), rotation: Quaternion.Euler(0,180,0)},
  ...
  munaStatue.addComponent(new OnClick((): void => {
  ...
  // Spotlights
  const spotLight1 = CreateSpotlight(new Vector3(-0.04,0,0), Quaternion.Identity, new GLTFShape("models/room6/spotlightlight.glb"), "1", resources.sounds.spotlight)
  const spotLight2 = CreateSpotlight(new Vector3(-0.02,0,0), Quaternion.Euler(0,90,0), new GLTFShape("models/room6/spotlightlight.glb"), "0", resources.sounds.spotlight)
  const spotLight3 = CreateSpotlight(new Vector3(-0.03,0,0), Quaternion.Euler(0,180,0), new GLTFShape("models/room6/spotlightlight.glb"), "4", resources.sounds.spotlight)
  ...
  const dialogTree = new SimpleDialog.DialogTree()
      .if(()=>firstTimeDialog)
          ...
          .showPortrait(SimpleDialog.PortraitIndex.RIGHT, resources.textures.npcPortraitDefault)
          .say(()=>"Hi there stranger!",{color: npcColor})
          .showPortrait(SimpleDialog.PortraitIndex.LEFT, resources.textures.playerPortraitSurprised)
          .say(()=>"A talking dog statue?!",{color: playerColor})
          .showPortrait(SimpleDialog.PortraitIndex.RIGHT, resources.textures.npcPortraitSurprised)
          .say(()=>"You're a talking bear yourself... you don't see me making any judgements.",{color: npcColor})
          .showPortrait(SimpleDialog.PortraitIndex.LEFT, resources.textures.playerPortraitThinking)
          .showPortrait(SimpleDialog.PortraitIndex.RIGHT, resources.textures.npcPortraitDefault)
          .say(()=>"Anyway... how do I get out of this place?",{color: playerColor})
          .showPortrait(SimpleDialog.PortraitIndex.RIGHT, resources.textures.npcPortraitThinking)
          ...
          .wait(3)
      .else()
          .showPortrait(SimpleDialog.PortraitIndex.LEFT, resources.textures.playerPortraitDefault)
          .showPortrait(SimpleDialog.PortraitIndex.RIGHT, resources.textures.npcPortraitThinking)
