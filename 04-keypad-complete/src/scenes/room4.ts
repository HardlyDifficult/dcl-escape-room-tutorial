...
export function CreateRoom4(gameCanvas: UICanvas): void {
  ...
  const paintingHintImage = CreateUIImage(
    paintingHintRect,
    fernTexture,
    new Vector2(392, 512),
    new Vector2(261, 341),
  ...
  const paintingHintClose = CreateUIImage(
    paintingHintRect,
    closeTexture,
    new Vector2(32, 32),
    new Vector2(32, 32),
    new Vector2(196 - 32, 256 - 32)
  );
  ...
  let panelCloseButton = CreateUIImage(
    panelRect,
    closeTexture,
    new Vector2(32, 32),
    new Vector2(32, 32),
  ...
  for (let i = 0; i < 3; i++) {
    let inputSlot = {
      image: new UIImage(panelRect, inputTexture),
      text: new UIText(panelRect)
    };
  ...
  carpet.addComponent(
    new ToggleComponent(ToggleComponent.State.Off, value => {
      if (value == ToggleComponent.State.On) {
        carpet.addComponentOrReplace(
          new RotateTransformComponent(
            carpet.getComponent(Transform).rotation,
  ...
  const coinHintImage = CreateUIImage(
    coinHintRect,
    coinTexture,
    new Vector2(392, 512),
    new Vector2(261, 341),
  ...
  const coinHintClose = CreateUIImage(
    coinHintRect,
    closeTexture,
    new Vector2(32, 32),
    new Vector2(32, 32),
